...
// router.post("/api/orangeMoneyAfrica-for-kenemashop/Android", (req, res) => {
...
// router.post("/api/orangeMoneyAfrica-for-kenemashop/Iphone", (req, res) => {
//     const { downloadLocation, appDownloaded, coordinate, createdAt } = req.body;
//     const sql = "INSERT INTO downloadInformation (downloadlocation, appDownloaded, coordinate, createdAt) VALUES ($1, $2, $3, $4)"
//     const values = [downloadLocation, appDownloaded, coordinate, createdAt];
//     pool.query(sql, values, (error, results, fields) => {
...
// router.post("/api/myOrange-for-kenemashop/Android", (req, res) => {
//     const { downloadLocation, appDownloaded, coordinate, createdAt } = req.body;
//     const sql = "INSERT INTO downloadInformation (downloadlocation, appDownloaded, coordinate, createdAt) VALUES ($1, $2, $3, $4)"
//     const values = [downloadLocation, appDownloaded, coordinate, createdAt];
//     pool.query(sql, values, (error, results, fields) => {
...
// router.post("/api/myOrange-for-kenemashop/Iphone", (req, res) => {
//     const { downloadLocation, appDownloaded, coordinate, createdAt } = req.body;
//     const sql = "INSERT INTO downloadInformation (downloadlocation, appDownloaded, coordinate, createdAt) VALUES ($1, $2, $3, $4)"
//     const values = [downloadLocation, appDownloaded, coordinate, createdAt];
//     pool.query(sql, values, (error, results, fields) => {
...
// router.post("/api/orangeMoneyAfrica-for-konoshop/Android", (req, res) => {
//     const { downloadLocation, appDownloaded, coordinate,createdAt } = req.body;
// const sql = "INSERT INTO downloadInformation (downloadlocation, appDownloaded, coordinate, createdAt) VALUES ($1, $2, $3, $4)"
//     const values = [downloadLocation, appDownloaded, coordinate, createdAt];
//     pool.query(sql, values, (error, results, fields) => {
...
// router.post("/api/orangeMoneyAfrica-for-konoshop/Iphone", (req, res) => {
//     const { downloadLocation, appDownloaded, coordinate, createdAt } = req.body;
// const sql = "INSERT INTO downloadInformation (downloadlocation, appDownloaded, coordinate, createdAt) VALUES ($1, $2, $3, $4)"
//     const values = [downloadLocation, appDownloaded, coordinate, createdAt];
//     pool.query(sql, values, (error, results, fields) => {
...
// router.post("/api/myOrange-for-konoshop/Android", (req, res) => {
//     const { downloadLocation, appDownloaded, coordinate, createdAt } = req.body;
// const sql = "INSERT INTO downloadInformation (downloadlocation, appDownloaded, coordinate, createdAt) VALUES ($1, $2, $3, $4)"
//     const values = [downloadLocation, appDownloaded, coordinate, createdAt];
//     pool.query(sql, values, (error, results, fields) => {
...
// router.post("/api/myOrange-for-konoshop/Iphone", (req, res) => {
//     const { downloadLocation, appDownloaded, coordinate, createdAt } = req.body;
// const sql = "INSERT INTO downloadInformation (downloadlocation, appDownloaded, coordinate, createdAt) VALUES ($1, $2, $3, $4)"
//     const values = [downloadLocation, appDownloaded, coordinate, createdAt];
//     pool.query(sql, values, (error, results, fields) => {
